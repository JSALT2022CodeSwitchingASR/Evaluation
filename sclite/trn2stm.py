...
def convert(trn=None, stm=None, orig_stm=None):
    ...
    for i, line in enumerate(content):
        ...
        col2 = segm_info[2]
        col3 = segm_info[3] + "_" + segm_info[4] 
		
        start_time = str(int(remove_dec_point(str(segm_info[-2])))) 
        end_time = str(int(remove_dec_point(str(segm_info[-1])))) 
        col4 = (
